...
<div className="lg:-mt-8 lg:w-3/12" >
        <div className={`${show ? 'max-lg:w-64 fixed max-lg:top-28 left-0  py-0 shadow shadow-none lg:pt-16 fixed lg:sticky top-0 left-0 right-0 py-0 shadow lg:shadow-none'
