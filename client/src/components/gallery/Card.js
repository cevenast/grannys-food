...
export default function Card({title, user, tags, imgSrc, id, description}){
    ...
    return(
        <section className="flex flex-col flex-wrap justify-start h-[22rem] w-60 mb-12 mx-auto p-2 shadow shadow-slate-400">
            ...
            <span className="align-top text-xs text-zinc-400"><a className="hover:text-[#cdbbb2]" href="#">{`@${user}`}</a></span>
